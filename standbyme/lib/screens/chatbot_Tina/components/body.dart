...
class _BodyState extends State<Body> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        ...
        title:
            Text("Tina", style: TextStyle(color: kPrimaryColor, fontSize: 24)),
        centerTitle: false,
        leading: Image.asset(
  ...
  Future _dialogFlowRequest({String query}) async {
    _addMessage(
        name: 'Tina', text: 'Escrevendo...', type: ChatMessageType.received);

    // Faz a autenticação com o serviço, envia a mensagem e recebe uma resposta da Intent
    AuthGoogle authGoogle =
        await AuthGoogle(fileJson: "assets/chatbot-tina-tove-7b0ee63e45bb.json")
            .build();
          ...
          data == 0
              ? Container(
                  ...
                  child: CircleAvatar(
                    ...
                    backgroundImage:
                        AssetImage("assets/chatbotTina/iconTina.jpg"),
                  ),
                )
              : Container(),
          Padding(
